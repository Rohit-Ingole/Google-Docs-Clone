        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="">
            <div className="">
              ...
              <div className="flex items-center place-content-between ml-2 mt-2">
                <p className="text-md">Blank</p>
                <p className="text-red-400 sm:text-sm md:text-lg">
                  * Deleting is one step process. Be Carefull!
                </p>
              </div>
            </div>
          </div>
